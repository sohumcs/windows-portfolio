      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-6 border-b pb-4">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Sohum Chandra Srivastava - Professional Portfolio
            </p>
          </div>
        </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Love building and playing games and interactive experiences
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-medium text-gray-800">Ginger Tea Powered</h3>
                  <p className="text-sm text-gray-600">
                    Average 4 cups per day, best code written at 2 AM
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mt-6 bg-blue-50 border-l-4 border-blue-500 p-4 rounded">
          <p className="text-gray-700 italic">
            "Code is poetry written in logic. Every bug is a puzzle waiting to
            be solved, and every feature is a story waiting to be told."
          </p>
        </div>
      </div>
    </div>
